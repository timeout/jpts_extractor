require 'jpts_extractor/stack'
require 'jpts_extractor/handler/article_handler'
require 'jpts_extractor/handler/front_handler'
require 'jpts_extractor/handler/journal_meta_handler'
require 'jpts_extractor/handler/article_meta_handler'
require 'jpts_extractor/handler/abstract_handler'
require 'jpts_extractor/handler/section_handler'
require 'jpts_extractor/handler/table_wrap_handler'
require 'jpts_extractor/handler/table_handler'
require 'jpts_extractor/handler/figure_handler'
require 'jpts_extractor/handler/back_handler'
require 'jpts_extractor/handler/ref_list_handler'
require 'jpts_extractor/handler/ref_handler'
require 'jpts_extractor/handler/acknowledge_handler'
require 'jpts_extractor/handler/body_handler'
require 'jpts_extractor/handler/null_handler'
