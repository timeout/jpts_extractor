...
RSpec.describe TeiToFo::Builder::SectionBuilder do

  let(:builder) { TeiToFo::Builder::SectionBuilder.new }

  describe '#initialize' do
    it 'instantiates a caption' do
      expect(builder.sec).not_to be_nil
      expect(builder.sec.class).to be(TeiToFo::ArticlePart::Section)
    end
  end
