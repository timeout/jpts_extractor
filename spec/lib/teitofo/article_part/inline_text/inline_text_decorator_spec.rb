...
RSpec.describe TeiToFo::ArticlePart::InlineText::InlineTextDecorator do

  let(:inline_text) { TeiToFo::ArticlePart::InlineText::InlineText.new('This is some text') }
  let(:decorator) { TeiToFo::ArticlePart::InlineText::InlineTextDecorator.new(inline_text) }
