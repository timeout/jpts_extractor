...
RSpec.describe TeiToFo::Handler::AbstractHandler do

  let(:subhandler) { TeiToFo::Handler::AbstractHandler.new }

  describe '#initialize' do
    it 'instantiates a CaptionBuilder builder' do
      expect(subhandler.builder).not_to be_nil
      expect(subhandler.builder.class).to be(TeiToFo::Builder::AbstractBuilder)
    end
  end
