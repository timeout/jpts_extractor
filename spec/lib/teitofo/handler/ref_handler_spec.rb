...
RSpec.describe TeiToFo::Handler::RefHandler do

  let(:subhandler) { TeiToFo::Handler::RefHandler.new }
  ...
  describe '#initialize' do
    ...
    it 'creates an ArticleMetaBuilder' do
      expect(subhandler.builder.class).to be(TeiToFo::Builder::RefBuilder)
    end
  end
