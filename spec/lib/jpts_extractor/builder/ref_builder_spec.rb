...
RSpec.describe JPTSExtractor::Builder::RefBuilder do

  let(:builder) { JPTSExtractor::Builder::RefBuilder.new }

  describe '#initialize' do
    it 'creates a JPTSExtractor::ArticlePart::Ref' do
      expect(builder.ref.class).to be(JPTSExtractor::ArticlePart::Ref)
    end
  end
