...
RSpec.describe JPTSExtractor::Handler::SectionHandler do

  let(:subhandler) { JPTSExtractor::Handler::SectionHandler.new }

  describe '#initialize' do
    it 'instantiates a CaptionBuilder builder' do
      expect(subhandler.builder).not_to be_nil
      expect(subhandler.builder.class).to be(JPTSExtractor::Builder::SectionBuilder)
    end
  end
