require 'jpts_extractor/handler/table_cell_handler'

RSpec.describe JPTSExtractor::Handler::TableCellHandler do

  let(:subhandler) { JPTSExtractor::Handler::TableCellHandler.new }

  describe '#initialize' do
    it 'instantiates a TableCellHandlerBuilder' do
      expect(subhandler.builder).not_to be_nil
      expect(subhandler.builder.class).to be(JPTSExtractor::Builder::TableCellBuilder)
    end
  end
